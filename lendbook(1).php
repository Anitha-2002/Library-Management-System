...
if(isset($_POST['submit'])){
	...
	$sql = "INSERT INTO borrow(memberName, regNo, bookName, borrowDate, returnDate) values('$name','$number', '$bdate', '$due')";
		...
		<div class="jumbotron login col-lg-10 col-md-11 col-sm-12 col-xs-12">
			...
			<div class="container">
				...
				<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="memberName" id="memberName" value="" placeholder="Enter the name">
						</div>
				</div>

				<div class="form-group">
						<label for="Register No" class="col-sm-2 control-label">REGISTER NO</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="regNo" value="" placeholder="Enter the register number">
						</div>		
				</div>
				...
				<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="bookName" id="bookTitle" placeholder="Enter Book Title">
				        </div>		
					</div>
